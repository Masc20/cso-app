...
export default function CommitteeVideoModal({
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      className="!max-w-4xl max-h-[calc(100dvh-2rem)] sm:max-h-[calc(100dvh-3rem)] flex flex-col rounded-2xl [&>div:last-child]:flex [&>div:last-child]:flex-1 [&>div:last-child]:min-h-0 [&>div:last-child]:flex-col [&>div:last-child]:!p-0"
    >
        {/* Modal Header */}
        <div className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 border-b border-cso bg-[#f4f4f2]/50 dark:bg-[#18181b]/50 shrink-0">
        ...
        {/* Modal Footer CTA */}
        <div className="p-3 sm:px-6 sm:py-4 border-t border-cso bg-[#f4f4f2]/50 dark:bg-[#18181b]/50 flex items-center justify-between gap-3 sm:gap-4 shrink-0">
          <button
            onClick={onClose}
          ...
          <button
            ...
            className="px-3 sm:px-6 py-2.5 rounded-lg bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-neutral-950 font-black text-[11px] sm:text-xs uppercase tracking-wider flex items-center gap-1.5 sm:gap-2 shadow-lg transition-transform active:scale-95"
          >

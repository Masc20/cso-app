...
export default function ApplicationDetailModal({ application, onClose, onUpdate }: ApplicationDetailModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-[#fafaf8] dark:bg-[#18181b] border border-[#e0e0da] dark:border-[#27272a] w-full max-w-2xl rounded-3xl p-6 sm:p-8 shadow-2xl relative my-8">
        
        {/* Header Bar */}
        <div className="flex items-center justify-between border-b border-neutral-200 dark:border-[#27272a] pb-4 mb-6">
          <div>
            <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold border ${getStatusBadgeClass(status)}`}>
              {status}
            </span>
          ...
          <button
            onClick={onClose}
            className="p-2.5 rounded-full bg-[#ebebe8] dark:bg-[#27272a] text-neutral-700 dark:text-neutral-200 hover:bg-[#e0e0da] dark:hover:bg-[#3f3f46] transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="space-y-6 text-xs sm:text-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-[#f4f4f2] dark:bg-[#121215] p-4 rounded-2xl border border-neutral-300 dark:border-[#27272a]">
            <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="p-4 rounded-2xl bg-neutral-200 dark:bg-[#27272a] border border-neutral-300 dark:border-[#3f3f46]">
              <span className="text-[11px] font-extrabold uppercase text-neutral-500 dark:text-neutral-400 block mb-1">
          ...
          <div>
            ...
            <div className="p-4 rounded-2xl bg-white dark:bg-[#121215] border border-neutral-300 dark:border-[#27272a] text-neutral-800 dark:text-neutral-200 leading-relaxed font-medium">
          ...
          <div className="pt-4 border-t border-neutral-200 dark:border-[#27272a] space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2.5 rounded-xl bg-white dark:bg-[#121215] border border-neutral-300 dark:border-[#27272a] text-neutral-900 dark:text-neutral-100 text-xs font-bold focus:outline-none focus:ring-2 focus:ring-amber-500/50"
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-xl bg-white dark:bg-[#121215] border border-neutral-300 dark:border-[#27272a] text-neutral-900 dark:text-neutral-100 text-xs font-medium focus:outline-none focus:ring-2 focus:ring-amber-500/50"
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              <button
                onClick={handleSave}
                disabled={saving}
                className="px-6 py-2.5 rounded-xl bg-neutral-900 hover:bg-neutral-800 text-white dark:bg-neutral-100 dark:text-neutral-900 font-extrabold text-xs uppercase tracking-wider transition-all flex items-center gap-1.5 shadow-md disabled:opacity-50"
              >
